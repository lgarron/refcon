...
public class Axiom2PointToPoint extends Axiom {

	private final Point p1;
	private final Point p2;
	private final Line foldLine;
	
	private Axiom2PointToPoint(Point p1, Point p2) {
		this.p1 = p1;
		this.p2 = p2;
	...
	public static Line fold(Point p1, Point p2) {
		return (new Axiom2PointToPoint(p1, p2)).foldLine;
	}
	...
	public String description(Locus locus) {
		return "Create " + locus.name() + " by folding " + p1.name() + " onto " + p2.name() + ".";
	}
